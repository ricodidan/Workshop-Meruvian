...
import org.meruvian.workshop.content.database.CatDatabase;

/**
 * Created by Enrico_Didan on 27/12/2016.
 */

public class CatContentProvider extends android.content.ContentProvider {
    public static final String TABLES[] =
            {
                    CatDatabase.NEWS_TABLE,
            };
    public static final String AUTHORITY = CatContentProvider.class.getName().toLowerCase();
    public static final String CONTENT_PATH = "content://" + AUTHORITY + "/";
    private CatDatabase dbHelper;
    ...
    public boolean onCreate() {
        dbHelper = new CatDatabase(getContext());
        return false;
    }
